...
const Lyrics = (props) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.lyrics.get?commontrack_id=${id}&apikey=ccbd5850fa5229291c6f6572d9fad3dd`
      )
      .then((res) => {
        ...
        return axios.get(
          `https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.get?commontrack_id=${id}&apikey=ccbd5850fa5229291c6f6572d9fad3dd`
        );
      })
      .then((res) => {
